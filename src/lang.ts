const lang = {
  ...
  'EditProfile.PersonalChannel.Label': 'Channel',
  'EditProfile.PersonalChannel.Add': 'Add',
  'EditProfile.PersonalChannel.Title': 'Personal Channel',
  'EditProfile.PersonalChannel.Description': 'Display the channel you manage in your profile.',
  'EditProfile.PersonalChannel.PickerTitle': 'Select Channel',
  'EditProfile.PersonalChannel.NoChannels': 'You have no eligible channels.',
  'EditProfile.PersonalChannel.Remove': 'Remove Channel',
  'ChatAutomation.Title': 'Chat Automation',
  'ChatAutomation.ProfileLabel': 'Chat automation',
  'ChatAutomation.ProfileDescription': 'Add a bot to answer messages on your behalf.',
  'ChatAutomation.Off': 'Off',
  'ChatAutomation.LoadFailed': 'Couldn\'t load',
  'ChatAutomation.HeroTitle': 'Chatbots',
  'ChatAutomation.HeroDescription': 'Add a bot to your account to help you automatically process and respond to the messages you receive. [Learn More >]()',
  'ChatAutomation.ChooseBot': 'Choose a bot to manage your chats automatically.',
  ...
  'ChatAutomation.SetupNotCompletedText': 'You haven’t added a bot to manage your account. Leave anyway?',
  'ChatAutomation.SetupNotCompletedLeave': 'Leave',
  ...
  'ChatAutomation.ExcludeChats': 'Exclude Chats',
  'ChatAutomation.SelectChats': 'Select Chats',
  'ChatAutomation.ExcludedDescription': 'Select chats or entire chat categories which the bot **WILL NOT** have access to.',
  'ChatAutomation.IncludedDescription': 'Select chats or entire chat categories which the bot **WILL** have access to.',
  'ChatAutomation.RecipientCategories': 'Chat categories',
  'ChatAutomation.RecipientSummaryEmpty': 'Add',
  'ChatAutomation.ExistingChats': 'Existing Chats',
  'ChatAutomation.NewChats': 'New Chats',
  'ChatAutomation.Contacts': 'Contacts',
  'ChatAutomation.NonContacts': 'Non-Contacts',
  'ChatAutomation.Permissions': 'Bot permissions',
  'ChatAutomation.PermissionsDescription': 'The bot can only reply on your behalf in chats that were active during the last 24h.',
  'ChatAutomation.ManageMessages': 'Manage Messages',
  'ChatAutomation.ReadMessages': 'Read Messages',
  'ChatAutomation.Reply': 'Reply to Messages',
  'ChatAutomation.MarkRead': 'Mark Messages as Read',
  'ChatAutomation.DeleteSent': 'Delete Sent Messages',
  'ChatAutomation.DeleteReceived': 'Delete Received Messages',
  'ChatAutomation.ManageProfile': 'Manage Profile',
  'ChatAutomation.EditName': 'Edit Name',
  'ChatAutomation.EditBio': 'Edit Bio',
  'ChatAutomation.EditPhoto': 'Edit Profile Photo',
  'ChatAutomation.EditUsername': 'Edit Username',
  'ChatAutomation.ManageGifts': 'Manage Gifts and Stars',
  'ChatAutomation.ViewGifts': 'View Gifts',
  'ChatAutomation.SellGifts': 'Sell Gifts',
  'ChatAutomation.ChangeGiftSettings': 'Change Gift Settings',
  'ChatAutomation.TransferGifts': 'Transfer and Upgrade Gifts',
  'ChatAutomation.TransferStars': 'Transfer Stars',
  'ChatAutomation.ManageStories': 'Manage Stories',
  'ChatAutomation.PermissionWarningTitle': 'Warning',
  'ChatAutomation.PermissionWarningProceed': 'Proceed',
  'ChatAutomation.UsernameWarning': 'The bot **%s** will be able to **set and remove usernames** for your account, which may result in the loss of your current username.',
  'ChatAutomation.GiftsWarning': 'The bot **%s** will be able to **manage your gifts**, including giving them away to other users.',
  'ChatAutomation.StarsWarning': 'The bot **%s** will be able to **transfer your stars**.',
  'ChatAutomation.GiftsAndStarsWarning': 'The bot **%s** will be able to **manage your gifts and stars**, including giving them away to other users.',
  'ChatAutomation.SaveSuccess': 'Chat automation updated.',
  'ChatAutomation.RecipientsEmpty': 'Please choose at least one recipient.',
  'ChatAutomation.RecipientLimit': 'You can select up to 100 users.',
  'ChatAutomation.Session': 'Chat Automation Bot',
  'ChatAutomation.ConnectedFrom': 'Connected from',
  'ChatAutomation.SessionDate': 'Date',
  'ChatAutomation.SessionDevice': 'Device',
  'ChatAutomation.SessionLocation': 'Location',
  'ChatAutomation.ManageAutomation': 'Manage Chat Automation',
  'ChatAutomation.TerminateSession': 'Terminate Session',
  'ChatAutomation.TerminateConnectedBot': 'Also terminate %s',
  'ChatAutomation.BotManagesChat': 'bot manages this chat',
  'ChatAutomation.BotPaused': 'bot paused',
  'ChatAutomation.BotHasAccess': 'bot has access to this chat',
  'ChatAutomation.Start': 'Start',
  'ChatAutomation.Stop': 'Stop',
  'ChatAutomation.ManageBot': 'Manage bot',
  'ChatAutomation.RemoveFromChat': 'Remove bot from this chat',
  'ChatAutomation.RevokeFromChat': 'Revoke access to this chat',
  'ChatAutomation.ViaBotTooltip': 'Only you can see that this message was sent by the bot.',
  'ChatAutomation.ConnectionReview.Title': 'A bot just got access to your messages!',
  'ChatAutomation.ConnectionReview.Text': 'connected to your account from %s. Was this you?',
  'ChatAutomation.ConnectionReview.TextNoLocation': 'connected to your account. Was this you?',
  'ChatAutomation.ConnectionReview.Confirm': 'Yes, it\'s me',
  'ChatAutomation.ConnectionReview.Reject': 'No, it\'s not me!',
  'ChatAutomation.ConnectionReview.Confirmed': 'New bot allowed.',
  'ChatAutomation.ConnectionReview.Rejected': 'Bot access revoked.',
  ...
  'ClientPip.PlaceholderTitle': 'Telegram is in Picture-in-Picture',
  'ClientPip.PlaceholderDescription': 'Switch back to this tab to bring it here, or use the button below.',
  'ClientPip.ReturnToTab': 'Return to tab',
  'ClientPip.FullscreenHint': 'Return to the tab to enter fullscreen',
  'ClientPip.Exit': 'Exit Picture-in-Picture',
  ...
  'Deactivated.OtherClient.Title': 'App is inactive...',
  'Deactivated.OtherClient.Subtitle': 'Another app is running.\nClick anywhere to continue using this app.',
  ...
  'KeyboardShortcuts.Section.Messages.Caption': 'Choose how messages are sent and how new lines are inserted.',
  ...
  'KeyboardShortcuts.Section.MediaEditor': 'Media Editor',
  'KeyboardShortcuts.Section.Other': 'Other',
  ...
  'KeyboardShortcuts.Action.Send': 'Send message',
  ...
  'KeyboardShortcuts.Action.JumpToInputStart': 'Jump to start of input',
  'KeyboardShortcuts.Action.JumpToInputEnd': 'Jump to end of input',
  'KeyboardShortcuts.Action.NextChat': 'Next chat',
  'KeyboardShortcuts.Action.PreviousChat': 'Previous chat',
  'KeyboardShortcuts.Action.OpenSearch': 'Open search',
  'KeyboardShortcuts.Action.SavedMessages': 'Open Saved Messages',
  ...
  'KeyboardShortcuts.Action.ZoomIn': 'Zoom in',
  'KeyboardShortcuts.Action.ZoomOut': 'Zoom out',
  'KeyboardShortcuts.Action.NextStory': 'Next story',
  'KeyboardShortcuts.Action.PreviousStory': 'Previous story',
  'KeyboardShortcuts.Action.CloseStories': 'Close stories',
  'KeyboardShortcuts.Action.PlayPauseStory': 'Play / pause story',
  'KeyboardShortcuts.Action.Undo': 'Undo',
  'KeyboardShortcuts.Action.Redo': 'Redo',
  'KeyboardShortcuts.Action.LockPasscode': 'Lock by passcode',
  'KeyboardShortcuts.Hint.LockPasscodeNotSet': 'set in Privacy and Security',
  'KeyboardShortcuts.Hint.SendDepends': 'depends on settings',
  ...
  'Suggestion.BirthdayContacts.Single': 'It’s %s\'s birthday today! 🎂',
  'Suggestion.BirthdayContacts.Multiple': {
    'one_value': '%d contact has a birthday today! 🎂',
    'other_value': '%d contacts have birthdays today! 🎂'
  },
  'Suggestion.BirthdayContacts.Subtitle': 'Send them a Gift.',
  'Suggestion.BirthdayContacts.Yesterday': 'Birthday yesterday',
  'Suggestion.BirthdayContacts.Today': 'Birthday today',
  'Suggestion.BirthdayContacts.Tomorrow': 'Birthday tomorrow',
  'Suggestion.BirthdayContacts.Dismissed': 'You can send a Gift later in Settings.',
  'GiftRecipientDoesNotAccept': 'This user doesn’t accept gifts.',
  ...
  'UnconfirmedAuthDeniedTitle': {
    'one_value': 'New Login Prevented',
    'other_value': 'New Logins Prevented'
  },
  'UnconfirmedAuthDeniedMessageSingle': 'We have terminated the login attempt from %s.',
  'UnconfirmedAuthDeniedWarning': 'Never send your login code to anyone or you can lose your Telegram account!',
  'UnconfirmedAuthDeniedButton': 'Got it',
  ...
  'MediaViewer.Context.Copy': 'Copy Media',
  ...
  'ChannelAutotranslation.BoostTitle': 'Autotranslation of Messages',
  'ChannelAutotranslation.BoostDescription': 'Your channel needs to reach **Level %d** to enable autotranslation of messages.',
  'Translate': 'Translate',
  ...
  'Chat.Service.NewCreatorPending': '%s will become the new owner in 7 days if %s does not return.',
  'Chat.Service.ChangeCreator': '%s made %s the new owner of the group.',
  ...
  'ReactionsNotifyContacts': 'My Contacts',
  'ReactionsNotifyEveryone': 'Everyone',
  ...
  'DeleteMessagesOptionAlsoChat': 'Also clear for all members',
  'DeleteForAll': 'Delete for all members',
  'ClearHistory': 'Clear history',
  'AlertClearHistory': 'Clear History',
  'ClearHistoryOptionAlso': 'Also clear history for %1$s',
  ...
  'AreYouSureClearHistoryWithChannel': 'Are you sure you want to clear the channel history in **%1$s**?',
  'AreYouSureClearHistorySavedMessages': 'Are you sure you want to clear **Saved Messages**?',
  ...
  'ShareMyPhoneNoCaps': 'Share my phone number',
  ...
  'ReportSpamUserEmojiStatusHint': 'This account uses %1$s as a custom status next to its name. Such emoji statuses are available to all subscribers of %2$s.',
  'ChatWithGroupAdmin': '**%1$s** is an admin of **%2$s**, a group you requested to join.',
  'ChatWithChannelAdmin': '**%1$s** is an admin of **%2$s**, a channel you requested to join.',
  'ChatWithAdminGroupTitle': 'Chat with group\'s admin',
  'ChatWithAdminChannelTitle': 'Chat with channel\'s admin',
  'ChatWithAdminMessage': 'You received this message because you requested to join **%1$s** on %2$s',
  ...
  'MediaCopied': 'Media copied to clipboard',
  'MediaCopyFailed': 'Failed to copy media to clipboard',
  ...
  'AddBot': 'Add Bot',
  'BotAddToGroupOrChannel': 'Add to Group or Channel',
  'BotAddToGroupAbout': 'This bot is able to manage a group.',
  'BotAddToChannelAbout': 'This bot is able to manage a channel.',
  'BotAddToGroupOrChannelAbout': 'This bot is able to manage a group or channel.',
  'BotChooseGroup': 'Select a Group',
  'BotAddAsAdminGroupConfirm': 'Are you sure you want to add this bot as an admin in **%1$s**? It will have access to the list of anonymous admins.',
  'BotAddAsAdminChannelConfirm': 'Are you sure you want to add this bot as an admin in **%1$s**? It will have access to lists of channel admins and subscribers.',
  ...
  'DeleteAllReactions': 'Delete all reactions',
  ...
  'Story.Notification.Reacted': '%1$s to your story',
  'Story.Notification.ReactedHidden': 'New reaction to your story',
  ...
  'ShowAllReactions': 'Show All Reactions',
  'DeleteReaction': 'Delete Reaction',
  'TapAndHoldToDeleteReaction': 'Tap and hold to delete reaction.',
  ...
  'ChannelSettingsJoinRequestChannel': 'Approve new subscribers',
  'ChannelSettingsJoinRequestInfo': 'Turn this on if you want users to join only after they are approved by an admin.',
  'GroupRequestApproved': 'Your request to join the group was approved',
  'GroupRequestApprovedChannel': 'Your request to join the channel was approved',
  'GroupRequestDeclined': 'Your request to join the group was declined.',
  'GroupRequestDeclinedChannel': 'Your request to join the channel was declined.',
  'GroupRequestSent': 'You will be added to the group once an admin approves your request.',
  'GroupRequestSentChannel': 'You will be added to the channel once its admins approve your request.',
  'WebAppGuardDisclaimerText': '**%1$s** uses **%2$s** to welcome new members. You must agree to the [Terms of Use]() of mini apps to continue.',
  'GuardBotProcessJoinRequests': 'Process Join Requests',
  'GuardBotProcessJoinRequestsInfo': 'Allow this bot to approve new members using its own interfaces, such as captchas.',
  'GuardBotEnableMembersText': 'New members will now need approval from **%s** before they can send messages in this group',
  'GuardBotEnableSubscribersText': 'New subscribers will now need approval from **%s** before they can join this channel',
  'GuardBotEnable': 'Enable',
  'GuardBotReplaceTitle': 'Replace Bot',
  'GuardBotReplaceText': '**%1$s** is currently processing join requests. Switch to **%2$s** instead?',
  'GuardBotReplaceUse': 'Use %s',
  'GuardBotManagedBy': 'Managed by %s',
  'Chat.Service.CommunityAdded.Group.By': '%1$s added this group to %2$s community',
  'Chat.Service.CommunityAdded.Group.Unknown': 'This group was added to %1$s community',
  'Chat.Service.CommunityAdded.Group.You': 'You added this group to %1$s community',
  'Chat.Service.CommunityRemoved.Group.By': '%1$s removed this group from a community',
  'Chat.Service.CommunityRemoved.Group.You': 'You removed this group from a community',
  'Chat.Service.CommunityAdded.Channel': 'The channel was added to %1$s community',
  'Chat.Service.CommunityRemoved.Channel': 'The channel was removed from a community',
  'Chat.Service.CommunityAdded.Bot': 'The bot was added to %1$s community',
  'Chat.Service.CommunityRemoved.Bot': 'The bot was removed from a community',
  'Community.CommunityAdded.View': 'View',
  'Community.Title': 'Community',
  'Community.Description': 'Make your group part of a community with multiple related chats.',
  'Community.ChannelDescription': 'Make your channel part of a community with multiple related chats.',
  'Community.BotDescription': 'Make your bot part of a community with multiple related chats.',
  'Community.AddGroup': 'Add Group to a Community',
  'Community.AddChannel': 'Add Channel to a Community',
  'Community.AddBot': 'Add Bot to a Community',
  'Community.Create': 'Create Community',
  'Community.AddExisting': 'Add to an existing community',
  'Community.Name': 'Name',
  'Community.WhoCanAddChats': 'Who can add chats?',
  'Community.AllMembers': 'All Members',
  'Community.AllMembersInfo': 'Allow members to add their groups and channels to the community.',
  'Community.OnlyAdmins': 'Only Admins',
  'Community.OnlyAdminsInfo': 'Chats suggested by community members require admin approval.',
  'Community.ChatVisibility': 'Chat visibility',
  'Community.ChatSettings': 'Community Chat Settings',
  'Community.Visible': 'Visible',
  'Community.VisibleInfo': 'Anyone in the community will be able to see this chat.',
  'Community.Hidden': 'Hidden',
  'Community.HiddenInfo': 'Only invited members and community admins will see this chat.',
  'Community.VisibilityImmutable': 'You won\'t be able to change this later.',
  'Community.SaveChanges': 'Save Changes',
  'Community.Edit': 'Edit Community',
  'Community.AddChat': 'Add Chat',
  'Community.AddTo': 'Add to Community',
  'Community.AddGroupConfirm': 'If this group is approved by a Community admin, its members will be able to join or request to join other chats in the Community.',
  'Community.AddChannelConfirm': 'If this channel is approved by a Community admin, its subscribers will be able to join or request to join other chats in the Community.',
  'Community.AddBotConfirm': 'If this bot is approved by a Community admin, Community members will be able to see and use it.',
  'Community.AddChatButton': 'Add a Chat to Community',
  'Community.NoCommunities': 'You have no communities yet.',
  'Community.NoChatsToAdd': 'There are no chats available to add.',
  'Community.CreateChat': 'Create a New Chat',
  'Community.PendingRequests': 'Pending Requests',
  'Community.PendingRequest': 'Pending Request',
  'Community.PendingRequestsCount': {
    'one_value': '%d chat suggested',
    'other_value': '%d chats suggested'
  },
  'Community.NoRequests': 'no requests',
  'Community.NoPendingRequests': 'No Pending Requests',
  'Community.SuggestedBy': 'Suggested by',
  'Community.Someone': 'Someone',
  'Community.SuggestedGroup': 'suggested this group',
  'Community.SuggestedChannel': 'suggested this channel',
  'Community.SuggestedBot': 'suggested this bot',
  'Community.SuggestedBySomeone': 'Someone suggested this chat',
  'Community.RequestAdded': 'Chat added to the community.',
  'Community.RequestDeclined': 'Suggestion declined.',
  'Community.AdminRequired': 'You no longer have permission to manage these requests.',
  'Community.RequestFailed': 'The request could not be updated. Please try again.',
  'Community.RequestsLoadFailed': 'Pending requests could not be loaded. Please try again.',
  'Community.Retry': 'Retry',
  'Community.PendingRequestsInfo': 'Chats require admin approval before they\'re added to the community.',
  'Community.ChangeSettings': 'Change Settings >',
  'Community.RequestsAdded': {
    'one_value': '%d chat added to the community.',
    'other_value': '%d chats added to the community.'
  },
  'Community.RequestsDeclined': {
    'one_value': '%d suggestion declined.',
    'other_value': '%d suggestions declined.'
  },
  'Community.AddAll': 'Add All',
  'Community.DeclineAll': 'Decline All',
  'Community.AddAllRequests': 'Add All Chats',
  'Community.AddAllRequestsConfirm': 'Add all %d pending chats to this Community?',
  'Community.DeclineAllRequests': 'Decline All Requests',
  'Community.DeclineAllRequestsConfirm': 'Decline all %d pending chat suggestions?',
  'Community.NoAdministrators': 'No administrators',
  'Community.NoRemovedUsers': 'No removed users',
  'Community.AdministratorsInfo': 'You can add admins to help you manage your Community.',
  'Community.RemovedUsersInfo': 'Users removed from the Community cannot rejoin it via invite links.',
  'Community.RemovedFromCommunity': 'Removed from the Community',
  'Community.Unban': 'Unban',
  'Community.LoadMore': 'Load More',
  'Community.AdminEditInfo': 'Edit Community Info',
  'Community.AdminEditChats': 'Edit Chat List',
  'Community.AdminBanMembers': 'Ban Members',
  'Community.BanFromCommunity': 'Ban from the Community',
  'Community.RemoveUser': 'Remove User',
  'Community.BanFromCommunityInfo': {
    'one_value': 'The user will be removed from %d Community chat.',
    'other_value': 'The user will be removed from %d Community chats.'
  },
  'Community.BanWarningTitle': 'Warning',
  'Community.BanWarning': 'Banning %1$s will also remove %2$d chats they created from the Community.',
  'Community.Ban': 'Ban',
  'Community.Banned': '%s was banned from the Community.',
  'Community.AdminAddAdmins': 'Add Community Admins',
  'Community.PromoteAdmin': 'Promote to Administrator',
  'Community.PromoteAdminConfirm': 'Make %s an administrator of this Community?',
  'Community.Promote': 'Promote',
  'Community.RemoveAdmin': 'Remove Administrator',
  'Community.RemoveAdminConfirm': 'Remove this administrator from the Community?',
  'Community.ChatsCount': {
    'one_value': '%d chat',
    'other_value': '%d chats'
  },
  'Community.ProfileStatus': {
    'one_value': 'Community with %d chat',
    'other_value': 'Community with %d chats'
  },
  'Community.BannedCount': {
    'one_value': '%d banned',
    'other_value': '%d banned'
  },
  'Community.PeersLimit': {
    'one_value': 'Limit of %d chat reached.',
    'other_value': 'Limit of %d chats reached.'
  },
  'Community.BotPeersLimit': {
    'one_value': 'Limit of %d bot reached.',
    'other_value': 'Limit of %d bots reached.'
  },
  'Community.Chats': 'Community Chats',
  'Community.ChatsJoined': 'Chats you are in',
  'Community.ChatsVisible': 'Chats you can view',
  'Community.ChatsRequestable': 'Chats you can request to join',
  'Community.ChatsHidden': 'Hidden chats',
  'Community.HiddenChatInfo': 'You can\'t join or view this chat until an admin invites you.',
  'Community.HiddenChannelInfo': 'You can\'t join or view this channel until an admin invites you.',
  'Community.HiddenBotInfo': 'You can\'t use this bot until an admin invites you.',
  'Community.ShowAsOne': 'Show as One Chat',
  'Community.ShowAsOneInfo': 'Group all community chats into one item in the chat list.',
  'Community.ShowSeparately': 'Show as Separate Chats',
  'Community.JoinConfirm': 'Do you want to join %s?',
  'Community.RequestJoinConfirm': 'Send a request to join %s?',
  'Community.RequestSent': 'Request sent',
  'Community.GroupRequestSent': 'Your request to join the group was sent to its admins.',
  'Community.ChannelRequestSent': 'Your request to join the channel was sent to its admins.',
  'Community.GroupNotAccessible': 'This group is no longer accessible.',
  'Community.ChannelNotAccessible': 'This channel is no longer accessible.',
  'Community.BotNotAccessible': 'This bot is no longer accessible.',
  'Community.PrivateChatInfo': 'This group is invite-only. Only its members can view it.',
  'Community.PrivateChannelInfo': 'This channel is invite-only. Only its subscribers can view it.',
  'Community.PrivateBotInfo': 'This bot is invite-only. Only invited members can use it.',
  'Community.MessageOwner': 'Message Group Owner',
  'Community.MessageChannelOwner': 'Message Channel Owner',
  'Community.MessageBotOwner': 'Message Bot Owner',
  'Community.GroupFull': 'This group has reached its member limit.',
  'Community.GroupAdded': 'Group added to the community',
  'Community.ChannelAdded': 'Channel added to the community',
  'Community.BotAdded': 'Bot added to the community',
  'Community.RemoveGroup': 'Remove Group from Community',
  'Community.RemoveChannel': 'Remove Channel from Community',
  'Community.RemoveBot': 'Remove Bot from Community',
  'Community.RemoveConfirm': 'Remove %s from this Community?',
  'Community.Removed': 'Group removed from the community',
  'Community.ChannelRemoved': 'Channel removed from the community',
  'Community.BotRemoved': 'Bot removed from the community',
  'Community.View': 'View Community',
  'Community.RemoveChat': 'Remove from Community',
  'Community.RemoveChatConfirm': 'Remove %s from this Community?',
  'Community.ChatRemoved': 'Chat removed from the community',
  'Community.Delete': 'Delete Community',
  'Community.DeleteConfirm': 'Delete this Community? This action cannot be undone.',
  'Community.Deleted': 'Community deleted',
  'Community.Leave': 'Leave Community',
  'Community.LeaveConfirm': 'Are you sure you want to leave %s?',
  ...
  'StarsNotAvailableTitle': 'Not Available',
  'StarsNotAvailableText': 'Sorry, no star purchases are available from your country.',
  'StarsPurchaseUnavailable': 'Purchasing stars is not available at this time.',
  ...
  'StarGiftResaleOnlyTon': 'The seller only accepts Grams as payment.',
  ...
  'StarGiftSellTitleTon': 'Price in Grams',
  ...
  'StarGiftYouWillReceiveTon': 'You will receive **%s** Grams.',
  ...
  'StarGiftMinSellAmountTon': 'You must request minimum %s Grams',
  'StarGiftMaxSellAmountTon': 'You can request maximum %s Grams',
  'StarGiftOnlyAcceptTon': 'Only Accept Grams',
  'StarGiftOnlyAcceptTonInfo': 'If the buyer pays you in Grams there\'s no risk of refunds, unlike Star payments.',
  ...
  'Call.StatusGroupInvite': 'Telegram Group Call',
  ...
  'Chat.Service.NoForwardsToggle.Enabled': '%s disabled sharing in this chat',
  ...
  'Chat.Service.ConferenceCall.Invitation': 'Group call invitation',
  'Chat.Service.ConferenceCall.Ongoing': 'Ongoing group call',
  'Chat.Service.ConferenceCall.Incoming': 'Incoming group call. [Join](open)',
  'Chat.Service.ConferenceCall.Outgoing': 'Outgoing group call. [Open](open)',
  'Chat.Service.ConferenceCall.Missed': 'Missed group call',
  'Chat.Service.ConferenceCall.Declined': 'Declined group call',
  'Call.Open': 'Open call',
  'ConferenceCall.Invite.Title': 'Add People',
  'ConferenceCall.Invite.Button': 'Call',
  'ConferenceCall.Invite.ViaLink': 'Invite via Link',
  'ConferenceCall.Invite.Done': 'You\'re calling **%1$@** to join.',
  'ConferenceCall.Invite.DoneMany': {
    'one_value': 'You\'re calling **%d person** to join.',
    'other_value': 'You\'re calling **%d people** to join.'
  },
  'ConferenceCall.Invite.Already': '**%1$@** is already in the call.',
  'ConferenceCall.Invite.AlreadyMany': {
    'one_value': '**%d person** is already in the call.',
    'other_value': '**%d people** are already in the call.'
  },
  'ConferenceCall.Invite.Fail': 'Couldn\'t call **%1$@** to join.',
  'ConferenceCall.Invite.FailMany': {
    'one_value': 'Couldn\'t call **%d person** to join.',
    'other_value': 'Couldn\'t call **%d people** to join.'
  },
  'ConferenceCall.Invite.Kicked': '**%1$@** was banned from the call.',
  'ConferenceCall.Invite.KickedMany': {
    'one_value': '**%d person** was removed from the call.',
  ...
  'ConferenceCall.Create.Button': 'Start',
  'ConferenceCall.Join.Title': 'Group Call',
  'ConferenceCall.Join.Text': 'You are invited to join a Telegram Call.',
  'ConferenceCall.Join.TextInviter': '**%1$@** is inviting you to join a Telegram Call.',
  'ConferenceCall.Join.AlreadyOne': '**%1$@** already joined this call.',
  'ConferenceCall.Join.AlreadyTwo': '**%1$@** and **%2$@** already joined this call.',
  'ConferenceCall.Join.AlreadyThree': '**%1$@**, **%2$@** and **%3$@** already joined this call.',
  'ConferenceCall.Join.AlreadyMany': {
    'one_value': '**%2$@**, **%3$@** and **%1$d** other person already joined this call.',
    'other_value': '**%2$@**, **%3$@** and **%1$d** other people already joined this call.'
  },
  ...
  'ConferenceCall.Controls.EnterFullscreen': 'Enter full screen',
  'ConferenceCall.Controls.ExitFullscreen': 'Exit full screen',
  'ConferenceCall.Controls.ShowParticipants': 'Show participants',
  'ConferenceCall.Controls.HideParticipants': 'Hide participants',
  'ConferenceCall.Media.MicrophoneError': 'Could not change the microphone state. Check microphone access and try again.',
  'ConferenceCall.Media.CameraError': 'Could not change the camera state. Check camera access and try again.',
  'ConferenceCall.Media.ScreenError': 'Could not change screen sharing. Try again.',
  ...
  'Peer.Activity.Chat.Pair.PlayingGame': '%1$@ and %2$@ are playing a game',
  'Peer.Activity.Chat.Pair.TypingText': '%1$@ and %2$@ are typing',
  'Peer.Activity.Chat.Pair.SendingPhoto': '%1$@ and %2$@ are sending photos',
  'Peer.Activity.Chat.Pair.RecordingVideo': '%1$@ and %2$@ are recording video',
  'Peer.Activity.Chat.Pair.SendingVideo': '%1$@ and %2$@ are sending videos',
  'Peer.Activity.Chat.Pair.RecordingAudio': '%1$@ and %2$@ are recording voice',
  'Peer.Activity.Chat.Pair.SendingFile': '%1$@ and %2$@ are sending files',
  'Peer.Activity.Chat.Pair.ChoosingSticker': '%1$@ and %2$@ are choosing stickers',
  ...
  'PrivacySettingsController.SetPhotoForRest': 'Set Public Photo',
  'PrivacySettingsController.UpdatePhotoForRest': 'Update Public Photo',
  ...
  'UserInfo.PhotoSetToast': 'You will now always see this photo for %1$s\'s account.',
  'UserInfo.PhotoSuggestedToast': 'Photo suggested to %1$s',
  'UserInfo.PhotoResetToast': 'Custom photo removed',
  'Action.SuggestedProfilePhoto': 'un1 suggests this photo for your Telegram profile',
  ...
  'GroupStickers.SectionInfo': 'You can choose a sticker set which will be available for every member while in the group chat.',
  'GroupStickers.LinkPlaceholder': 'Sticker set link',
  'GroupStickers.LinkInfo': 'You can choose a sticker set that will be available to all members of this group.',
  'GroupStickers.NotFound': 'Sticker set not found.',
  'GroupStickers.MySets': 'My sticker sets',
  'GroupStickers.CreateInfo': 'You can create your own custom sticker sets using the [@stickers]() bot.',
  'GroupStickers.Remove': 'Remove Group Sticker Set',
  'GroupStickers.Updated': 'Group sticker set updated',
  ...
  'GroupEmojiPack.Updated': 'Group emoji pack updated',
  'GroupEmojiPack.Removed': 'Group emoji pack removed',
  'GroupEmojiPack.LevelMin': 'Your group needs to reach Level %d to set a group emoji pack. [Boost group]().',
  'GroupEmojiPack.BoostTitle': 'Enable emoji pack',
  'GroupEmojiPack.BoostDescription': 'Your group needs to reach **Level %d** to set emoji pack.',
  ...
  'CallSettings.MicrophoneUnavailable': 'Microphone is unavailable. Check microphone access and try again.',
  'CallSettings.CameraUnavailable': 'Camera is unavailable. Check camera access and try again.',
  ...
  'UnsavedChangesDescription.ChatAutomation': 'You have changed your chat automation settings. Save changes?',
  ...
  'SuggestedPosts.TONAmount': '%d Grams',
  ...
  'TonGiftSubtitle': 'Use Grams to buy gifts and suggest posts to channels.',
  ...
  'AdminLog.ToggleSignatureProfilesEnabled': '%s enabled author profile visibility',
  'AdminLog.ToggleSignatureProfilesDisabled': '%s disabled author profile visibility',
  ...
  'StarGiftOffer.CreateOfferTON': 'Offer Grams',
  'StarGiftOffer.CreateOfferStars': 'Offer Stars',
  'StarGiftOffer.CreateOfferPlaceholderTON': 'Grams to offer',
  'StarGiftOffer.CreateOfferPlacholderStars': 'Stars to offer',
  'StarGiftOffer.CreateOfferSubtitleTON': 'Enter the amount of Grams you\'d like to offer for **%s**',
  ...
  'StarGiftOffer.OfferDurationDescriptionTON': 'Choose how long **%s** has to accept your offer. When it expires, your Grams will be refunded',
  ...
  'Ephemeral.VisibleYou': 'Only visible to you',
  'Ephemeral.VisibleTo': 'Only visible to %s',
  'Ephemeral.About': 'Only you can see this message. It will disappear after you restart the app.',
  'Ephemeral.CommandTooltip': 'Other members won’t see this message',
  'Ephemeral.ReplySingleMessage': 'You can send only one message in reply to this message.',
  'Ephemeral.SingleAttachment': 'You can attach only one file to an ephemeral message.',
  'Ephemeral.CantSchedule': 'Ephemeral messages can’t be scheduled.',
  'Ephemeral.UnsupportedContent': 'This content can’t be sent as an ephemeral message.',
  'Ephemeral.CommandAmbiguous': 'Add @username to choose which bot should receive this command.',
  'Ephemeral.CommandUnavailable': 'This bot isn’t available yet. Please try again.',
